...
const routes = [
    {
        ...
        children: [
            ...
            // Rendered inside the public layout so a 404 still has the navbar and
            // footer to navigate out of, instead of being a dead end.
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'admin.accounting.income-statement',
                component: () => import('@/views/admin/accounting/IncomeStatement.vue')
            },
            {
