...
const updateSEOMetaTags = () => {
    ...
    const visionTitle = settings.value.vision_title || 'الهوية والرؤية';
    const visionDescription = settings.value.vision_description || 'تعرف على رؤيتنا وقيمنا في تقديم أفضل قطع الغيار';
