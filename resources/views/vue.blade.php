    ...
    <script>
        ...
        window.systemData = {
            ...
            settings: {
                ...
                site_logo: {!! json_encode(get_setting('site_logo') ? asset('storage/' . get_setting('site_logo')) : asset('assets/images/logo.png')) !!},
                ...
                hero_bg: {!! json_encode(get_setting('hero_bg') ? asset('storage/' . get_setting('hero_bg')) : '') !!},
                favicon: {!! json_encode(get_setting('favicon') ? asset('storage/' . get_setting('favicon')) : asset('assets/images/favicon.ico')) !!},
                og_image: {!! json_encode(get_setting('og_image') ? asset('storage/' . get_setting('og_image')) : '') !!},
