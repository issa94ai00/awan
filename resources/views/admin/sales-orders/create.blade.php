...
<div class="page-header">
    <div class="page-title">
        ...
        <p>قم بملء البيانات الأساسية وإضافة المنتجات لتسجيل طلب بيع جديد في النظام</p>
    </div>
        ...
        <form action="{{ route('admin.sales-orders.store') }}" method="POST">
            ...
            <div class="form-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.5rem; margin-bottom: 1.5rem;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="shipping_address" class="form-control" placeholder="أدخل عنوان الشحن والتسليم...">
                </div>
            </div>
            ...
            <div class="form-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.5rem; margin-bottom: 1.5rem;">
                <div class="form-group">
                    ...
                    <div style="position: relative; display: flex; align-items: center;">
                        <input type="number" name="discount" class="form-control" value="0" step="0.01" style="padding-left: 2rem;">
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative; display: flex; align-items: center;">
                        <input type="number" name="tax" class="form-control" value="0" step="0.01" style="padding-left: 2rem;">
                        <span style="position: absolute; left: 12px; color: var(--text-light); font-weight: 600;">$</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="notes" class="form-control" rows="3" placeholder="أضف أي ملاحظات خاصة بالطلب هنا..."></textarea>
            </div>
            ...
            <div class="form-actions" style="border-top: 1px solid var(--border-color); padding-top: 1.5rem; display: flex; gap: 1rem; justify-content: flex-end;">
                <a href="{{ route('admin.sales-orders.index') }}" class="btn btn-secondary" style="border: 1px solid var(--border-color);">إلغاء</a>
                <button type="submit" class="btn btn-primary" style="padding-left: 2rem; padding-right: 2rem;"><i class="fas fa-save"></i> حفظ الطلب</button>
            </div>
        </form>
    </div>
</div>
