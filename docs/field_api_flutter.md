...
> **دورة الحياة كاملةً** — الموافقة، الشحن مقابل الاستلام من المستودع، وحركات
> المخزون على كل رِجل — في
> [`replenishment-transfer-lifecycle.md`](replenishment-transfer-lifecycle.md).
>
> باختصار: `pending` ← موافقة المصدر ⇒ إمّا `in_transit` (شُحنت وخرجت من المصدر)
> أو `ready_for_pickup` (محجوزة على الرف) ← الاستلام ⇒ `completed` والبضاعة في
> مستودع الطالب. **الموافقة تخصّ المصدر والاستلام يخصّ الوجهة.**
