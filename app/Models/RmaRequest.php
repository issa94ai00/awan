...
class RmaRequest extends Model
{
    ...
    // Goods physically returned and booked back into the warehouse.
    ...
    /** Credit notes issued when this return was settled. */
    ...
    /** Goods may be booked in (or a receipt corrected) while approved or received. */
    ...
    /**
     * Settling stays allowed straight from `approved` — not every return
     * requires goods back (e.g. a discarded damaged item) — but `received` is
     * now the normal route in.
     */
    ...
    public function markReceived($userId): void
    {
