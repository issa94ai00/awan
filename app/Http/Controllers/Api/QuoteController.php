...
class QuoteController extends Controller
{
     ...
     *
     * update() validates and rewrites the whole quote — it requires the full
     * items array and deletes/recreates every line — so it cannot be used to
     * move a quote from draft to sent. It also rejects quotes whose
     * `valid_until` has already passed (`after:today`), which would make expired
     * quotes impossible to mark as rejected. Mirrors the invoice status route.
     */
